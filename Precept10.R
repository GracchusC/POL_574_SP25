...
## Embeddings
#glove <- readRDS(url("https://www.dropbox.com/scl/fi/374is3tf282drdqyalq00/glove.rds?rlkey=8jt2diyvc1fcn11libusmkrea&st=unhz3sn4&dl=0"))
glove <- readRDS("/Users/christianbaehr/Dropbox/POL 574/glove.rds")
dim(glove)
rownames(glove)
